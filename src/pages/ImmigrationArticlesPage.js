...
const ImmigrationArticlesPage = () => {
  const slides = [
    [articles[22], articles[23], articles[31], articles[32], articles[33]],
    [articles[34], articles[35], articles[36], articles[37], articles[38]],
    [articles[39]],
  ];
...
export default ImmigrationArticlesPage;
